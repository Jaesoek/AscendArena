...
AAscendCharacter::AAscendCharacter()
{
...
void AAscendCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void AAscendCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
